...
function solution(clothes) {
    ...
    // 각 카테고리 개수 + 1 한 것을 다 곱하고 -1 하면 되는데
    // 이런 식을 도출하는 법은 모르겠음..
...
test.areEqualInt(solution([["yellow_hat", "headgear"], ["blue_sunglasses", "eyewear"], ["green_turban", "headgear"]]), 5);
test.areEqualInt(solution([["crow_mask", "face"], ["blue_sunglasses", "face"], ["smoky_makeup", "face"]]), 3);